 ...
 * @since 1.2.0
 */
public final class LockStoreSqlFactory {

    private LockStoreSqlFactory() {
    }

    private static final Map<String/*dbType*/, LockStoreSql> LOCK_STORE_SQL_MAP = Maps.newConcurrentMap();
