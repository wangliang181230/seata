...
public class DubboUtil {
    ...
    public static Class<?> getAssistInterface(Object proxyBean) throws NoSuchFieldException, SecurityException,
        ...
        Object invokerInvocationHandler = ReflectionUtil.getFieldValue(proxyBean, "handler");
        Object invoker = ReflectionUtil.getFieldValue(invokerInvocationHandler, "invoker");
        Object failoverClusterInvoker = ReflectionUtil.getFieldValue(invoker, "invoker");
